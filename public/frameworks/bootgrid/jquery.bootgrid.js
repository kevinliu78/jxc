...
;(function ($, window, undefined)
{
    ...
    */
    ...
    {
        var tbody = this.element.find("tbody").first(),
            tpl = this.options.templates,
    ...
    function renderRows(rows)
    {
        if (rows.length > 0)
        {
            var that = this,
                ...
                tbody = this.element.find("tbody").first(),
            ...
            tbody.html(html);
            //console.log(tbody)
            tbody.tableResize(this.options.tBodyHeight);
            //$.fn.tableResize(tbody);
    ...
    Grid.defaults = {
        ...
        rowCount: [10, 50, 100, 200], // rows per page int or array of int (-1 represents "All")
         ...
         **/
        css: {
            actions: "actions btn-group controls", // must be a unique class name or constellation of class names within the header and footer
            center: "text-center",
            ...
            left: "text-left",
            pagination: "pagination pagination-small", // must be a unique class name or constellation of class names within the header and footer
        ...
        templates: {
            ...
            footer: "<div id=\"{{ctx.id}}\" class=\"{{css.footer}}\"><div class=\"row\"><div class=\"col-sm-6 infoBar\"><p class=\"{{css.infos}}\"></p></div><div class=\"col-sm-6\" style='position: absolute;right: 10px;text-align:right;' ><p class=\"{{css.pagination}}\"></p></div></div></div>",
            ...
            headerCell: "<th data-column-id=\"{{ctx.column.id}}\" class=\"{{ctx.css}} relative\" style=\"{{ctx.style}}\"><a href=\"javascript:void(0);\" class=\"{{css.columnHeaderAnchor}} {{ctx.sortable}}\"><span class=\"{{css.columnHeaderText}}\">{{ctx.column.text}}</span>{{ctx.icon}}</a><i class='gridRsz' style='position: absolute;top: 0;right: 2px;width: 5px;height: 28px;z-index: 20;cursor: col-resize;'></i></th>",
            ...
            search: "<div class=\"{{css.search}}\"><div class=\"input-group\"><span style='font-size:12px;' class=\"{{css.icon}} input-group-addon {{css.iconSearch}}\"></span> <input type=\"text\" class=\"{{css.searchField}}\" placeholder=\"{{lbl.search}}\" /></div></div>",
